...
<div class="text-lg font-medium">
    ...
    {/if}
    <form id="submit-weight" on:submit|preventDefault={submitWeight} class="grid grid-cols-3">
        <input type="text" class="w-10 px-1 mx-1 bg-transparent text-right col-span-1" bind:value={weight} placeholder='enter weight'>kg
        <button type="submit" title="Save weight" class="items-center col-span-1">
