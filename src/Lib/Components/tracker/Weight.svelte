...
<div class="text-lg font-medium">
    ...
    <!-- {:else}
        <h1>{weight} kg</h1> -->
    {/if}
    <form id="submit-weight" on:submit|preventDefault={submitWeight} >
        <input type="text" class="w-10 px-1 mx-1 bg-transparent text-right" bind:value={weight} placeholder='enter weight'>kg
